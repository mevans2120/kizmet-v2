        ...
        <section className="py-16 md:py-20 bg-sage-50">
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <blockquote className="font-heading text-3xl italic text-secondary-foreground -mt-12 mb-6">
                {quote.text}
              </blockquote>
              ...
              <div className="md:hidden space-y-8">
                {journey.steps.map((step, index) => (
                  <div key={step._key || index} className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-heading text-xl font-medium text-secondary-foreground mb-2">
                        {step.title}
                      </h3>
                      <p className="font-body text-base text-muted-foreground leading-relaxed">
                        {step.description}
